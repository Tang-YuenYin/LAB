...
for(int i=0;i<owners.size();i++)
{
    ...
    if(owners.get(i).equalsIgnoreCase("Metallica"))
    {       
        continue;
    }
    ...
    {
        if(parcels.get(j).equalsIgnoreCase(owners.get(i)))
        {
            a.push(parcels.get(j));
        }
        if(parcels.get(j).equalsIgnoreCase("Metallica")&&owners.get(i).equalsIgnoreCase("King Crimson"))
        {
            a.push(parcels.get(j));
...
List.of("Whitesnake", "Whitesnake", "Whitesnake","Whitesnake", "Made in Heaven", "Made in Heaven", "Made in Heaven", "Made inHeaven", "C-Moon", "C-Moon", "C-Moon", "C-Moon"),
